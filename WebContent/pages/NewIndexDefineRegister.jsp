...
<table width="100%" height="100%"  >
  ...
  <html:form action="/NewIndexActionRegister">
					<%if(request.isRequestedSessionIdValid())	{%>
																...
																<td width="3%" align="left" class="tab">
																	<p align="left">
																		<html:radio value="1"
																			...
																			onclick="copycondition1()" disabled="true" />
																	</p>
																</td>
																<td width="45%" class="tab"><bean:message
																		key="defineIndex" /></td>
																...
																<td width="46%" align="left" class="tab">
																	<p align="left">
																		...
																		<html:select property="s_parentIndex"
																			onchange="return test3()" disabled="true">
															...
															<tr>
																...
																<td width="56%" align="left" class="tab">
																	&nbsp;&nbsp;<html:checkbox property="b_ShowChild"
																		onclick="testshowchildindexes()" disabled="true" /> <bean:message
																		key="defineIndex4" />
																</td>
															</tr>
															<tr>
														...
														<table border="0" width="100%" class="gridStyle"
															...
															<tr>
																...
																<td width="13%"><html:text
																		property="s_reutersCode" size="7" /></td>
															</tr>
															<tr>
																<td width="19%" align="right" class="tab"><bean:message
