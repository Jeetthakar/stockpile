/**
 * 	SortedTable: JavaScript file to sort the tables 
...
//		alert('inside init');
	...
	findTable:function() {
//		alert('find Table of class = sorted');
		var elms = document.getElementsByTagName('table');
		for (var i=0;i<elms.length;i++) {
			if (this.hasClass(elms[i],'sorted') && 
					!SortedTable.getSortedTable(elms[i])) 
				return elms[i];
		}
		return null;
	},
