...
<html:errors /> 
	...
	%>
       ...
       <table border="0" width="110%"  cellspacing="0" cellpadding="3" height="406">
        ...
        <tr>
          ...
          <font face="Arial" size="2">
	        ...
	        <%--commented <a href="./AddCurrency.jsp"><bean:message key="sysConfigForm.newcurrency"/></a >--%>
          ...
          <td align="left" nowrap="nowrap">
           ...
           <td align="left" nowrap="nowrap">
          	<font face="Arial" size="2">
	      	 	...
	      	 	<a href="./countries.jsp"><bean:message key="sysConfigForm.newcountry"/></a href>
		     </font>
          </td>
       ...
       <tr>
          <td align="left">
           	<font face="Arial" size="2" nowrap="nowrap">
           		<bean:message key="sysConfigForm.faceValue" />
          	</font>
          </td>  
          <td align="left" nowrap="nowrap">
          	<font face="Arial" size="2">
          		<logic:present name="sysConfigBean">
            		<logic:equal value="0" property="faceValue" name="sysConfigBean">
	            			<html:text property="faceValue" size="12" maxlength="15" value=""  />
	            	</logic:equal>
	              	<logic:notEqual value="0" property="faceValue" name="sysConfigBean">
	            			<html:text property="faceValue" size="12" maxlength="15" name="sysConfigBean"  />
	            	</logic:notEqual>
            	</logic:present>
            	</font>	
          </td>
          ...
          <td align="left">
           	<font face="Arial" size="2" nowrap="nowrap">
           		<bean:message key="sysConfigForm.paidValue" />
          	</font>
          </td>
          <td align="left" nowrap="nowrap">
          	<font face="Arial" size="2">
          		<logic:present name="sysConfigBean">
            		<logic:equal value="0" property="paidValue" name="sysConfigBean">
	            			<html:text property="paidValue" size="12" maxlength="15" value=""  />
	            	</logic:equal>
	              	<logic:notEqual value="0" property="paidValue" name="sysConfigBean">
	            			<html:text property="paidValue" size="12" maxlength="15" name="sysConfigBean"  />
	            	</logic:notEqual>
            	</logic:present>	
          </td>
        </tr>
        ...
        <td align="left" nowrap="nowrap">
           	<font face="Arial" size="2">
           		<bean:message key="sysConfigForm.s_indexType" />
          	</font>
           </td>
           <td align="left" nowrap="nowrap">
          	<font face="Arial" size="2">
          	 	<html:select property="s_indexType" size="1" >
					<html:optionsCollection name="sysConfigBean" property="s_indexTypeIndexCollection" />
            	</html:select>
	      	 </font>
          </td>
        ...
        <td align="left" nowrap="nowrap">
           	<font face="Arial" size="2">
           		<bean:message key="sysConfigForm.s_stockType" />
          	</font>
           </td>
           <td align="left" nowrap="nowrap">
          	<font face="Arial" size="2">
          	 	<html:select property="s_stockType" size="1">
					<html:optionsCollection name="sysConfigBean" property="s_stockTypeCollection" />
            	</html:select>
	      	 	<a href="./StockType.jsp?from=stkmaster"><bean:message key="stockmaster.new"/></a>
		     </font>
          </td>
