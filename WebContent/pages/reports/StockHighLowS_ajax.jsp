	 	...
	 	<tr>
			...
			<table border="1" width="100%" align="right" cellpadding="2" cellspacing="0" id="t1" class="sortable" bordercolor="#EFEFEF">
          		...
          		<tr>
          			...
          			<td nowrap="nowrap" align="center" class="gridStyle-header"><bean:message key="StockHighLow.ovalue" /></td>
		          	<td nowrap="nowrap" align="center" class="gridStyle-header"><bean:message key="StockHighLow.ovalue" /></td>
        		  	<td nowrap="nowrap" align="center" class="gridStyle-header"><bean:message key="StockHighLow.lowval" /></td>
          			<td nowrap="nowrap" align="center" class="gridStyle-header"><bean:message key="StockHighLow.hival" /></td>
          			<td nowrap="nowrap" align="center" class="gridStyle-header"><bean:message key="StockHighLow.trdvolume" /></td>
      		    	<td nowrap="nowrap" align="center" class="gridStyle-header"><bean:message key="StockHighLow.trdvalue" /></td>
          			<td nowrap="nowrap" align="center" class="gridStyle-header"><bean:message key="IndexDivisor.mcp" /></td>
          			<td nowrap="nowrap" align="center" class="gridStyle-header"><bean:message key="StockHighLow.numotrd" /></td>
          			<td nowrap="nowrap" align="center" class="gridStyle-header"><bean:message key="corporate.Date" /></td>
     			</tr> 
     		
     			<logic:iterate id="details" name="stockDetailsBean" property="tableData">
     			<tr>
     				<td valign="middle" bgcolor="white" align="left" class="gridStyle-odd">
        				<font face="Arial" size="2" color="blue"><bean:write name="details" property="stockName"/></font>
          			</td>
          			<td align="left" bgcolor="white" valign="middle" class="gridStyle-odd">
          				<font face="Arial" size="2" color="blue"><bean:write name="details" property="openVal"/></font>
          			</td>
          			<td bgcolor="white" align="left" valign="middle" class="gridStyle-odd">
          				<font face="Arial" size="2" color="blue"><bean:write name="details" property="closeVal"/></font>
          			</td>
          			<td bgcolor="white" align="left" valign="middle" class="gridStyle-odd">
          				<font face="Arial" size="2" color="blue"><bean:write name="details" property="lowVal"/></font>
         		 	</td>
       			   	<td bgcolor="white" align="left" valign="middle" class="gridStyle-odd">
       			   		<font face="Arial" size="2" color="blue"><bean:write name="details" property="highVal"/></font>
     		     	</td>
     		     	<td bgcolor="white" align="left" valign="middle" class="gridStyle-odd">
     		     		<font face="Arial" size="2" color="blue"><bean:write name="details" property="tradedVol"/></font>
       			   	</td>
         		 	<td bgcolor="white" align="left" valign="middle" class="gridStyle-odd">
         		 		<font face="Arial" size="2" color="blue"><bean:write name="details" property="tradedVal"/></font>
         		 	</td>
        		  	<td bgcolor="white" align="left" valign="middle" class="gridStyle-odd">
        		  		<font face="Arial" size="2" color="blue"><bean:write name="details" property="mcv"/></font>
        		  	</td>
      		    	<td bgcolor="white" align="left" valign="middle" class="gridStyle-odd">
      		    		<font face="Arial" size="2" color="blue"><bean:write name="details" property="noOfTrades"/></font>
      		    	</td>
      		    	<td bgcolor="white" align="left" valign="middle" nowrap="nowrap" class="gridStyle-odd">
      		    		<font face="Arial" size="2" color="blue"><bean:write name="details" property="date"/></font>
       			   	</td>
