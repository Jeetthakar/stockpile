	...
	int len=str1.length;
     ...
     {              
			for(j=0;j<len;j++)
			{
				...
				String str=str1[j];
				if(str.equals("Index Comparison"))
				{
	 ...
	 <%
             ...
             if(str.equals("Index Returns And Volatility"))
			 {
		...
		<%
             ...
             if(str.equals("Index Correlation"))
			 {
		...
		<%
             ...
             if(str.equals("Index Compare OHLC"))
						{
		...
		<TD bgcolor="LavenderBlush" valign="top" width="100%" height="500">
					...
					<div id="indreturnvol1" style="display:none"> 	
						...
						<bean:define id="details" name="batchReportBean" property="final_Vector"/>
					 	...
					 	<logic:empty property="final_Vector" name="batchReportBean">
						...
						<logic:notEmpty property="final_Vector"  name="batchReportBean">
	...
	<%	} %>      
		...
		<div id="indcompohlc1" style="display:none">
	 	...
	 	//	org.jfree.chart.demo.servlet.ComposeIndex ci=new org.jfree.chart.demo.servlet.ComposeIndex();
			...
			//String[] var={(String)vect.get(2),(String)vect.get(3),(String)vect.get(4)};
