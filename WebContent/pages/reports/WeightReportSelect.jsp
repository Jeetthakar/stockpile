...
background: lightyellow;
	...
	int len=str1.length;
     ...
     {              
					for(j=0;j<len;j++)
					{
                          ...
                          if(str.equals("Company Weightage"))
						{
	...
	%>    			<li><a href="#" onClick="compaweight()"><bean:message key="Company_Weightage" /></a></li>
	 ...
	 <%
            			...
            			else if(str.equals("Industry Weightage"))
						{
	...
	<%			
						...
						else if(str.equals("Stock Contribution To Change In Index"))
						{
	%>						
	...
	%>      
		...
		<div id=comweight style="display:inline"> 
		 ...
		 <%
            ...
            else if(s.equals("Industry Weightage"))
						{
