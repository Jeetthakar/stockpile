		...
		int len=str1.length;
    	 ...
    	 {              
					for(j=0;j<len;j++)
					{
                          ...
                          if(str.equals("Capital Change"))
						{
							
							
	%>    	   
	           				 <li><a href="#" onClick="capitalchange()"><bean:message key="Capital_Change"/></a></li>
	 ...
	 %>		
							...
							<li><a href="#" onClick="stockdetail()"><bean:message key="Stock_Details"/></a></li>
  ...
  harrier.income.com.report.BatchReportForm brf=(harrier.income.com.report.BatchReportForm)session.getAttribute("batchReportBean");
	...
	%>    
		...
		<div id=contentstart style="display:inline">
						...
						<bean:define id="detai" name="batchReportBean" property="tableDatac"/>	
						<logic:empty property="tableDatac" name="batchReportBean">
						...
						<logic:notEmpty property="tableDatac"  name="batchReportBean">
							...
							<tbody>
          						...
          						<logic:iterate id="detai" name="batchReportBean" property="tableDatac">
          							<tr>
     									<td valign="middle" bgcolor="white" align="left" class="gridStyle-odd" axis="sstring" headers="stockName"
           									title='<bean:write name="detai" property="stockName"/>'>
        									<font face="Verdana" size="2" color="blue"><bean:write name="detai" property="stockName"/></font>
          								</td>
          								<td align="right" nowrap="nowrap" bgcolor="white" valign="middle" class="gridStyle-odd" axis="number" headers="faceValue"
           									title='<bean:write name="detai" property="faceVal"/>'>
          									<font face="Verdana" size="2" color="blue"><bean:write name="detai" property="faceVal"/></font>
          								</td>
          								<td bgcolor="white" nowrap="nowrap" align="right" valign="middle" class="gridStyle-odd" axis="number" headers="totishares"
           									title='<bean:write name="detai" property="tis"/>'>
          									<font face="Verdana" size="2" color="blue"><bean:write name="detai" property="tis"/></font>
          	
          								</td>
          								<td bgcolor="white" align="right" nowrap="nowrap" valign="middle" class="gridStyle-odd" axis="number" headers="mcapvalue"
           									title='<bean:write name="detai" property="mcv"/>'>
          									<font face="Verdana" size="2" color="blue"><bean:write name="detai" property="mcv"/></font>
         	 							</td>
       		   							<td bgcolor="white" align="right" nowrap="nowrap" valign="middle" class="gridStyle-odd" axis="number" headers="invwf"
           									title='<bean:write name="detai" property="iwf"/>'>
       		 								<font face="Verdana" size="2" color="blue"><bean:write name="detai" property="iwf"/></font>
     		    						</td>
     		   							<td bgcolor="white" align="left" nowrap="nowrap" valign="middle" class="gridStyle-odd" axis="sstring" headers="Action"
           									title='<bean:write name="detai" property="corpAction"/>'>
     		   								<font face="Verdana" size="2" color="blue"><bean:write name="detai" property="corpAction"/></font>
       		   							</td>
         	 							<td bgcolor="white" align="right" nowrap="nowrap" valign="middle" class="gridStyle-odd" axis="date" headers="Applied"
           									title='<bean:write name="detai" property="date"/>'>
         	 								<font face="Verdana" size="2" color="blue"><bean:write name="detai" property="date"/></font>
         								</td> 	
			...
			%>	
	 	 	...
	 	 	<bean:define id="det" name="batchReportBean" property="tableDatas"/>		
	  		<logic:empty property="tableDatas" name="batchReportBean">
	  		  				<table border="0" align="left" width="631" height="222" cellspacing="0" cellpadding="0">
	  	   	 					<tr>
          							<td width="99"></td>
	  			   					<td class="gridStyle-message" align="center" valign="middle">
           	...
           	<logic:notEmpty property="tableDatas"  name="batchReportBean">
				...
				<tbody>
     			<logic:iterate id="det" name="batchReportBean" property="tableDatas">
     			<tr>
     				<td valign="middle" bgcolor="white" align="left" class="gridStyle-odd" axis="sstring" headers="stockName"
           			title='<bean:write name="det" property="stockName"/>'>
        				<font face="Verdana" size="2" color="blue">
        				<bean:write name="det" property="stockName"/></font>
          			</td>
          			<td align="right" bgcolor="white" valign="middle" class="gridStyle-odd" axis="number" headers="ovalue"   
	  		title='<bean:write name="det" property="openVal"/>'>
          				<font face="Verdana" size="2" color="blue">
          				<bean:write name="det" property="openVal"/></font>
          			</td>
          			<td bgcolor="white" align="right" valign="middle" class="gridStyle-odd" axis="number" headers="cloval"   
	  		title='<bean:write name="det" property="closeVal"/>'>
          				<font face="Verdana" size="2" color="blue">
          				<bean:write name="det" property="closeVal"/></font>
          			</td>
          			<td bgcolor="white" align="right" valign="middle" class="gridStyle-odd" axis="number" headers="lowval"   
	  		title='<bean:write name="det" property="lowVal"/>'>
          				<font face="Verdana" size="2" color="blue">
          				<bean:write name="det" property="lowVal"/></font>
         		 	</td>
       			   	<td bgcolor="white" align="right" valign="middle" class="gridStyle-odd" axis="number" headers="hival"   
	  		title='<bean:write name="det" property="highVal"/>'>
       			   		<font face="Verdana" size="2" color="blue">
       			   		<bean:write name="det" property="highVal"/></font>
     		     	</td>
     		     	<td bgcolor="white" align="right" valign="middle" class="gridStyle-odd" axis="number" headers="trdvolume"   
	  		title='<bean:write name="det" property="tradedVol"/>'>
     		     		<font face="Verdana" size="2" color="blue">
     		     		<bean:write name="det" property="tradedVol"/></font>
       			   	</td>
         		 	<td bgcolor="white" align="right" valign="middle" class="gridStyle-odd" axis="number" headers="trdvalue"   
	  		title='<bean:write name="det" property="tradedVal"/>'>
         		 		<font face="Verdana" size="2" color="blue">
         		 		<bean:write name="det" property="tradedVal"/></font>
         		 	</td>
        		  	<td bgcolor="white" align="right" valign="middle" class="gridStyle-odd" axis="number" headers="mcp"   
	  		title='<bean:write name="det" property="mcv"/>'>
        		  		<font face="Verdana" size="2" color="blue">
        		  		<bean:write name="det" property="mcv"/></font>
        		  	</td>
      		    	<td bgcolor="white" align="right" valign="middle" class="gridStyle-odd" axis="number" headers="numotrd"   
	  		title='<bean:write name="det" property="noOfTrades"/>'>
      		    		<font face="Verdana" size="2" color="blue">
      		    		<bean:write name="det" property="noOfTrades"/></font>
      		    	</td>
      		    	<td bgcolor="white" align="center" valign="middle" nowrap="nowrap" class="gridStyle-odd" axis="date" headers="Date"   
	  		title='<bean:write name="det" property="date"/>'>
      		    		<font face="Verdana" size="2" color="blue">
      		    		<bean:write name="det" property="date"/></font>
       			   	</td>
    			</tr>
				</logic:iterate> 
				</tbody>
