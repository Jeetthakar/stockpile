...
<head>
	...
	<title><bean:message key="MGainerLoosers.title" /></title>
</head>
<body onload="initialize()">
    <html:form action="/marketStatus">
	<div id="PageTitle">
    	...
    	<tr>
		   ...
		   <td  class="subHeader" width="665" align="left" colspan="2" nowrap="nowrap">
		   		<font size="3" face="Arial">
		        	<b><bean:message key="MGainerLoosers.title" /></b>
		         </font>
		   	</td> 
	  	</tr>
	</table> 
	</div>    
	<logic:equal value="no" property="compute" name="GainerLoosersBean">
		<span id="theTable1">	
		<table width="656">
       		<tr>
        		<td width="157" nowrap="nowrap" align="right">
 				...
 				<td width="489" nowrap="nowrap" align="left" height="30">
          			<html:select property="selectIndex" size="1" onchange="indiChange()" styleId="sIE">
						<html:optionsCollection property="selectIndexCollection" name="GainerLoosersBean"/>
					</html:select>
         		</td>
     		</tr>
 		</table> 
	...
	<logic:notEqual value="no" property="compute" name="GainerLoosersBean">
		<span id="theTable1">	
		<table width="656">
       		<tr>
        		<td width="157" nowrap="nowrap" align="right">
	...
	<logic:equal value="no" property="compute" name="GainerLoosersBean">
		...
		<table width="656">
       		<tr>
        		<td width="157" nowrap="nowrap" align="right">
					<font size="2" face="Arial">
           				<bean:message key="MGainerLoosers.select" />&nbsp;:
           			</font>
        		</td>    
 				<td width="489" nowrap="nowrap" align="left" height="30">
          			<html:select property="selectCriteria" size="1" onchange="indiChange()" styleId="sIE">
						<html:optionsCollection property="selectCriteriaCollection" name="GainerLoosersBean"/>
					</html:select>
         		</td>
     		</tr>
 		</table> 
        	...
        	<table>
        		<tr>
            		...
            		<td  nowrap="nowrap">
             		...
             		<td nowrap="nowrap"> 
               			<html:submit property="b1"  onclick="return go();" ><bean:message key="Reports.View"/>
               			</html:submit>&nbsp;&nbsp;
					</td>
				</tr>
        	</table>	
	  ...
	  <logic:notEqual value="yes" parameter="compute" >
	 	...
	 	<tr>
	 		...
	 		<td >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	  		...
	  		<bean:size id="dataCount" name="GainerLoosersBean" property="tableData"/>
	  		<bean:define id="details" name="GainerLoosersBean" property="tableData"/>
	  		<div id="chart" >
	  		<table>
	  			<tr>
	  				<td >
	  				<logic:equal name="GainerLoosersBean"  property="checkChart" value="on" >
	  				<jsp:setProperty name="GainerLoosersBean" property="checkChart"/>
	  					<p align="center">
    		  		  		<% 	
			...
			<table border="1" width="100%" align="right" cellpadding="2" cellspacing="0" id="t1" class="sortable" bordercolor="#EFEFEF">
 		      	<tr>
          			<td nowrap="nowrap" align="center"><bean:message key="MGainerLoosers.increase" /></td>
          			<td nowrap="nowrap" align="center"><bean:message key="corporate.stockname" /></td>
          			<td nowrap="nowrap" align="center"><bean:message key="Traded_Volume" /></td>
          		</tr> 
     		
     			<logic:iterate id="details" name="GainerLoosersBean" property="tableData">
     			<tr>
...
<table id="hiddenTable" height="100">
	...
	<td><font size="2" face="Arial"><b>&nbsp;&nbsp;&nbsp;
    	<bean:write name="GainerLoosersBean" property="indexName" /></b>
         </font>
	</td>
	</tr>
	<tr>
	...
	<td width="125" align="right"><font size="2" face="Arial"><b>
   	...
   	<td><font size="2" face="Arial">
   		<bean:write name="GainerLoosersBean" property="from"/>
   		</font>
   	</td> 
	</tr>
	<tr>
	<td width="125" align="right"><font size="2" face="Arial"><b>
   	...
   	<td><font size="2" face="Arial">
   		<bean:write name="GainerLoosersBean" property="to"/>
   		</font>
   	</td> 
	</tr>
</table>
...
function PrintThisPage() { 
	...
	function indiChange(){
		...
		//document.forms[0].submit();
		retrieveURL('/Stockpile/stockDetails.do?ask=COMMAND_NAME_1','GainerLoosersBean');
		//return true;
	}
function checkdate()
{
