...
<%@ page import="app.*"%>
<%@ page import="org.jfree.chart.demo.servlet.*"%><%@page
...
<body onload="initialize()">
		...
		<tr>
			...
			<td align="left" valign="top">
				<%
					...
					System.out.println("USER ID setting**** " + userid);
					ci.setUserid1(userid);
				%>
				<link href="./StyleSheet.css" rel="stylesheet" type="text/css">
				<script language="javascript" src="../Script/codethatcalendarstd.js"></script>
				<script language="javascript" src="box_ex.js"></script> <script
					language="javascript">
 ...
 %> <font size="2" face="Arial"> <bean:message
							...
							<%
								...
								System.out.println("User id getting *** " + ci.getUserid1());
								// 								ci.setVector_indexlist(chkchecked);
								//userId parameter is added by samiksha and created a new method
								ci.setVector_indexlist(chkchecked, ci.getUserid1());
								String str = "";
								if (request.isRequestedSessionIdValid())
									ci.setUserid1(session.getAttribute("userid").toString());
								...
								System.out.println("Get Vector index list *** " + v3.size());
								Iterator i1 = v3.iterator();
							%>
							<%
								if (!pr.equals("Y")) {
							%>
							<td width="400" nowrap="nowrap" align="left"><select
								size="3" name="D1" multiple>
 ...
 %>
							...
							<td width="30" nowrap="nowrap"><input
								onclick="c2.popup('to');" type="button" value="..."></td>
							...
							if (!pr.equals("Y")) {
								try {
									...
									astr = "./IndexCorrelation.jsp?Pr=Y" + url + "&from="
											+ fromdate + "&to=" + toDate;
									String excel = "./FileDownload.jsp?type=15" + url
											+ "&from=" + fromdate + "&to=" + toDate
											+ "&filename=IndexCorrelation.xls";
									String xml = "./FileDownloadXmlNew.jsp?type=15" + url
											+ "&from=" + fromdate + "&to=" + toDate
											+ "&filename=IndexCorrelation.xml";
									String pdf = "./FileDownload_Pdf.jsp?type=15" + url
											+ "&from=" + fromdate + "&to=" + toDate
											+ "&filename=IndexCorrelation.pdf";
									String str_url = "./EmailReport.jsp?switch_type=15&cas=15&rname=IndexCorrelation.xls&from="
											+ fromdate + "&to=" + toDate;
					%>
					<table width="800" cellpadding="0" cellspacing="0">
						<tr>
							...
							<td width="110" nowrap="nowrap"><font size="1"> <a
									href=<%=xml%>>Export to Xml</a>
							</font></td>
							<td width="110" nowrap="nowrap"><font size="1"> <a
									href=<%=pdf%>><bean:message key="LatestDivisor.pdfr" /></a>
							</font></td>
						...
						<tr>
							...
							<td width="770" nowrap="nowrap">
								...
								<table border="0" align="left" width="631" height="222"
									...
									<tr>
										<td align="center" valign="middle" bgcolor="#84AADE">
											<p style="margin-left: 9">
												<font face="Verdana" color="blue" size="5"> <bean:message
														key="StockPerformance.selData" /></font>
											</p>
										</td>
									</tr>
								</table> <%
 ...
 %>
								<table border="1" align="left" width="90%" class="gridStyle"
									...
									%>
									<tr>
										<td width="15%" align="left" valign="left" bgcolor="#84AADE"><%=i_cor.next()%></td>
										<%
