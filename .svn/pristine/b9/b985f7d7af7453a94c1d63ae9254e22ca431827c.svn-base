...
//	}
	...
	int_month = parseInt(strMonth, 10);         //Month
		...
		if (strYear.length == 2 && strYear >=80) {
			strYear = "19" + strYear;
...
function getCurrDate(objName) {
		//alert( "In Function");
		var Today = new Date();
		//alert(" in today"+Today);
		...
		//day = checkNoOfDigits(day);
		var month = Today.getMonth() +1;
		//alert(" Month " + month);

		//month= checkNoOfDigits(month);
