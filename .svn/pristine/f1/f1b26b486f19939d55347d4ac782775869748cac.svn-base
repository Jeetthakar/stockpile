...
public class UploadMessageFile {
	Logger Logging = Logger.getLogger(UploadMessageFile.class);
	/**
	 * method to upload the latest .dat message file from FTP server on current date and
	 * also return the filename of the latest .dat message file uploaded at destination
	 * folder (ftpDetails.properties - "mkt_ind_destination").
	 * 
	 * @return filename
	 */
	public String getLatestMessageFile() {
	//public static void main(String[] z){
		...
		try {
			...
			source = rs.getProperty("message_source");
			source = source + date1 + "/";
