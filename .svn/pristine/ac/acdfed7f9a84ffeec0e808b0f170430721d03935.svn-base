...
<head>
	...
	<title><bean:message key="Corporateview.title" /></title>
</head>
<body onload="initialize()">
    <html:form action="/stockDetails1">
    	...
    	<tr>
		   ...
		   <td  class="subHeader" width="665" align="left" colspan="2" nowrap="nowrap">
		   		<font size="3" face="Arial">
		        	<b><bean:message key="Corporateview.title" /></b>
		         </font>
		   	</td> 
	  	</tr>
	</table> 
	 ...
	 <logic:notEqual value="yes" parameter="compute" >
	 	...
	 	<tr>
	 		...
	 		<td >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	  		...
	  		<bean:size id="dataCount" name="stockDetailsBean" property="tableData1"/>
	  		<bean:define id="details1" name="stockDetailsBean" property="tableData1"/>
	  		<div id="chart" >
	  		<table>
	  			<tr>
	  				<td >
			...
			<table border="1" width="100%" align="right" cellpadding="2" cellspacing="0" id="t1" class="sortable" bordercolor="#EFEFEF">
          		...
          		<tr>
          			...
          			<td nowrap="nowrap" align="center"><bean:message key="corporate.caname" /></td>
          			<td nowrap="nowrap" align="center"><bean:message key="corporate.catype" /></td>
		          	<td nowrap="nowrap" align="center"><bean:message key="corporate.applydate" /></td>
        		  	<td nowrap="nowrap" align="center"><bean:message key="corporate.status" /></td>
          			
          			
     			</tr> 
     		
     			<logic:iterate id="details1" name="stockDetailsBean" property="tableData1">
     			<tr>
     				<td valign="middle" bgcolor="white" align="left" >
        				<font face="Arial" size="2" color="blue"><bean:write name="details1" property="stockName1"/></font>
          			</td>
          			<td align="left" bgcolor="white" valign="middle">
          				<font face="Arial" size="2" color="blue"><bean:write name="details1" property="camName"/></font>
          			</td>
          			<td bgcolor="white" align="left" valign="middle">
          				<font face="Arial" size="2" color="blue"><bean:write name="details1" property="caType"/></font>
          			</td>
          			<td bgcolor="white" align="left" valign="middle">
          				<font face="Arial" size="2" color="blue"><bean:write name="details1" property="applyDate"/></font>
         		 	</td>
       			   	<td bgcolor="white" align="left" valign="middle">
       			   		<font face="Arial" size="2" color="blue"><bean:write name="details1" property="status"/></font>
     		     	</td>
