...
<body>	
	...
	<td valign="middle" class="gridStyle-odd" nowrap="nowrap" align="left" axis="date" headers="trddate"
          			title='<bean:write name="details" property="tradingDate"/>'>
							          		...
							          		<td align="right" class="gridStyle-odd" bgcolor="white" valign="middle" axis="number" headers="close" nowrap="nowrap"
          			title='<bean:write name="details" property="close"/>'>
							          		...
							          		<td align="right" class="gridStyle-odd" bgcolor="white" valign="middle" axis="number" headers="mcapimil" nowrap="nowrap"
          			title='<bean:write name="details" property="marketCap"/>'>
							          		...
							          		<td align="right" class="gridStyle-odd" bgcolor="white" valign="middle" axis="number" headers="divisor" nowrap="nowrap"
	 ...
	 <%--Also for applying sort operation on table --%>
			...
			<td  align="right" nowrap="nowrap" class="gridStyle-odd" >
				<font face="Verdana" size="2" color="blue">
					<bean:write name="PortfolioReportBean" property="total"/>000
				</font>
