...
<tr>
	<td width="100%" bgcolor="#FFFFFF" height="1" align="center">
		<p>
			<font size="4" face="Arial Black">&nbsp;&nbsp; Child Index
				Composition</font>
		</p>
	</td>
</tr>
...
<%
	System.out.println("Form resubmitted2");
	System.out.println("Get base value page newIndexForm*****"+newIndexForm);
%>
<jsp:setProperty name="baseValues" property="newIndexForm"
	value="<%=newIndexForm%>" />
<logic:equal value="yes" scope="request" parameter="fromcomposition">
	<jsp:setProperty name="baseValues" property="fromComposition"
		value="yes" />
	<%
		System.out.println("Form resubmitted");
	%>
	<script>
...
<html:form action="/Proceed">
	...
	<tr>
		<td width="44%" align="left" bgcolor="#D8D8D8" height="23">
			<p>
				<font face="Arial" size="2">Parent INDEX Name: </font><font
					face="Arial" size="2" color="red"><bean:write
						name="newIndexForm" property="s_indexName" /></font>
			</p>
	...
	<tr>
		<td width="100%" bgcolor="#D8D8D8" height="99">&nbsp;
			...
			<table border="1" width="71%" bordercolorlight="#000000"
				cellspacing="0" cellpadding="0" bordercolordark="#000000">
				<tr>
					<td width="100%">
						<table border="1" width="100%" cellspacing="0" cellpadding="0">
							<tr>
								<td width="5%" align="center" bgcolor="#FFFFFF"><b>Sr.
										No.</b></td>
								<td width="23%" align="center" bgcolor="#FFFFFF"><font
									size="2" face="Arial"><b>Index Name</b></font></td>
								<td width="5%" align="center" bgcolor="#FFFFFF"><font
									size="2" face="Arial"><b>Base Value</b></font></td>
							</tr>
	...
	<tr>
		<td width="100%" bgcolor="#D8D8D8" height="40">
			<table border="0" width="100%" height="74">
				<tr>
					<td width="50%" height="70"><input type="submit"
						value="<< Back" name="B4"></td>
					<td width="50%" height="70"><input type="submit"
						value="Save and Continue" name="B3"></td>
				</tr>
			</table>
		</td>
	</tr>
	<tr>
		<form enctype="multipartform"></form>
	</tr>

	<logic:equal value="empty" name="baseValues" property="tableString">
		<script>
			
		<%System.out.println("Form resubmitted1");%>
			document.forms[0].submit();
		</script>
	</logic:equal>
</html:form>
