		...
		<% 		if(var != null)
				{
					try{
						String astr = null;
                        	...
                        	String excel = "./FileDownload.jsp?type=10"+url+"&from="+fromdate+"&to="+toDate+"&filename=IndexCompareOHLC.xls";
                        	String xml = "./FileDownloadXmlNew.jsp?type=10&"+url+"from="+fromdate+"&to="+toDate+"&filename=IndexCompareOHLC.xml";
                        	String pdf = "./FileDownload_Pdf.jsp?type=10&"+url+"from="+fromdate+"&to="+toDate+"&filename=IndexCompareOHLC.pdf";
							String str_url = "./EmailReport.jsp?switch_type=10&cas=10&rname=IndexCompareOHLC.xls&from="+fromdate+"&to="+toDate;
                        %> 
                        <p></p>
                        ...
                        <td width="110" nowrap="nowrap">	
							...
							<td width="110" nowrap="nowrap">	
							 <font size="1">
							 <a href=<%= pdf %>>
							<bean:message key="LatestDivisor.pdfr" /></a>
							</font>
							</td>
