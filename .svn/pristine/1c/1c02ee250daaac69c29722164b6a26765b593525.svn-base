...
<form method="POST" >
	...
	<% String var = request.getParameter("var"); 
		...
		<% if(res == 1) 
		{ %>
		<font face="Arial" color="#008000">Message sent</font></b></p>
		<% }else if(res == 0)
		{%>
		<font face="Arial" color="red">Message not sent due to some errors. Please try again</font></b></p>
		<% } %>
		<hr></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<% 
			...
			String url = null;
			if (cas == "1")
				url = "./pages/indexcompose.jsp";
			else if(cas == "2")
				url = "./pages/CompanyWiseWeightage.jsp?var="+var;
			else if(cas == "3")
				url = "./pages/indwiseweight.jsp?var="+var;
		 	else if(cas == "4")
				url = "./pages/DisplayIndexes1.jsp?var="+var;
			else url = "./pages/DisplayIndexes1.jsp";
		 %>
