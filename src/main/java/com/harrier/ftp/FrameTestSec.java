...
public class FrameTestSec extends JFrame{	
	...
	public static void main(String[] args) {
		//MyDom d1=new MyDom();
    	final JLabel SECDetails = new JLabel(" SEC File details");
    	...
    	MyDom d1=new MyDom();
    	String source="CM05/Security/August312006/";
    	String destination="D://DownLoadSec//";
    	//String destination1="D://DownLoad1//";
    	//new ClientSec( d1.s1 ,d1.s2 ,d1.s3,source,destination).start();
    	new ClientSec("203.199.75.115","C05023","HIS468",source,destination).start();
    	//new MktThrDB(name);
		new Timer(1000, new ActionListener(){		
					
            public void actionPerformed(ActionEvent evt) {
               String name = SECThread.str;
               FName.setText(name);
               
               
               long length=SECThread.len;
               FileSize.setText(Long.toString(length)+"Bytes");
               
               int num=SECThread.nofiles;
               NumFile.setText(Integer.toString(num));  
               
               String filetime=SECThread.rightnow;
		...
		SECDetails.setBounds(new java.awt.Rectangle(15,15,100,20));
		
		contentPane = new JPanel();
		contentPane.setLayout(null);
		contentPane.add(SECDetails, null);
        ...
        final FrameTestSec f = new FrameTestSec();
