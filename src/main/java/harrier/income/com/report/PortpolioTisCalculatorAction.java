...
public class PortpolioTisCalculatorAction extends Action{
	...
	public ActionForward execute(ActionMapping mapping,ActionForm form,HttpServletRequest request,
			HttpServletResponse response)
		{
			...
			String id1=null;
		   String but_pressed=null;
		   String savebut=null;
		   savebut=(String)indexCalculatorForm.getSaveButton();
		   
		   
		   but_pressed=indexCalculatorForm.getB1();
		   if(savebut==null){//no button pressed 
			   	id1=request.getParameter("index_id");//get index selected
			   	if(id1==null){
			   		return fr= new ActionForward("/pages/reports/PortpolioTisCalculator.jsp");//if no index selected return control back to index calculator page
			   	}
				...
				//indexCalculatorCollection.insertIndexValues(form);		   
				 return fr= new ActionForward("/pages/reports/PortpolioTisCalculator.jsp");
		   }else{
			   if(savebut.equals("Submit"))//if submit button pressed
			   {
				...
				//indexCalculatorCollection.insertIndexValues(form);		   
				indexCalculatorForm.setSaveButton(null);
				return fr= new ActionForward("/pages/reports/PortpolioTisCalculator.jsp?opt=Submit");
			   }
			   if(savebut.equals("Reset"))//true if button pressed is reset
			   {
			   log.debug("button pressed is reset");	
			    String button="Reset";	
				//id1=request.getParameter("index_id");
			    //indexCalculatorForm.setIndex_id(id1);
			    indexCalculatorForm.setSaveButton(null);
				return fr= new ActionForward("/pages/reports/PortpolioTisCalculator.jsp?opt=Reset");
			   }	
		   }
