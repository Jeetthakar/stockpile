 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class DynaReportAction extends Action 
{
	Logger Logging = Logger.getLogger(DynaReportAction.class);
	public static final String FORWARD_start1 = "success";
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		Logging.debug("at action.");
		DynaReportForm dyn = (DynaReportForm) form;
		Connection con = null;
		Connect c = ConnectInit.getConnect();
		ResultSet rst = null;
		PreparedStatement pst = null;
		String sqlString = dyn.getSqltext();
		...
		return new ActionForward("/pages/report/DynaReport.jsp");
	}
}
