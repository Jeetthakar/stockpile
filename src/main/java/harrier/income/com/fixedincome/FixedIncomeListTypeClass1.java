...
public class FixedIncomeListTypeClass1 {	
	static Logger Logging = Logger.getLogger(FixedIncomeListTypeClass1.class);
...
public static ResultSet check_corp(Connection con,String query,FixedIncomeCorporate corporateact)
{
	ResultSet rs=null;
...
public static StringBuffer select_stock(Connection con,String query,String query1,FixedIncomeCorporate corporateact)
{
...
public static StringBuffer select_stock1(Connection con,String query,String query1,FixedIncomeCorporate corporateact,String exc)
{
	StringBuffer str =new StringBuffer();
	try
	{		
...
public static ResultSet getResult_event2(Connection con,String query,String date,String date1,String exc,String stk){
	...
	public static void event_list(FixedIncomeCorporate corporateact,ResultSet rs)
	{
		try
		{
		...
		else
		{
			...
			ResultSet rs1=FixedIncomeListTypeClass1.getResult12(con,query,corporateact.getStid());		
			if(rs1.next())
			{			
	...
	public static void affect_index_list(Connection con,FixedIncomeCorporate corporateact,String query,String stock)
	{
		try
		{	
	...
	public static void affect_child_list(Connection con,FixedIncomeCorporate corporateact,String query)
	{
		try
		{		
			Hashtable hash_affect=corporateact.getHash_affind();
	...
	public static void add_affect(Connection con,String query,FixedIncomeCorporate corporateact)
	{
		try{
...
public static void check_corp_name(ResultSet rs,String corp,FixedIncomeCorporate corporateact)
{	
	String cid=null;
	try{
		while(rs.next())
	...
	public static void stock_corpdetail(FixedIncomeCorporate corp)
	{
		Connect connect = ConnectInit.getConnect();
		Connection con=null;
		try{
			...
			ResultSet rs=FixedIncomeListTypeClass1.getAffected(con,query,corp.getCad_id());
			rs.next();
	...
	public static void corp_detail(FixedIncomeCorporate corp)
	{
		Connect connect = ConnectInit.getConnect();
		Connection con=null;
	...
	public static ResultSet check_type_diary(FixedIncomeCorporate corporate,String fdate,String tdate,String type)
	{
		ResultSet rs=null;
		Connect connect = ConnectInit.getConnect();
		Connection con=null;	
//		Change by Manoj Adekar for Dynamic connection using getdbConnection() instead of  getConnection()
	...
	public static ResultSet check_hist_list(Connection con,Connect connect,String query,FixedIncomeCorporate corp,String stock)
	{
		ResultSet rs=null;
		try{
			PreparedStatement  stmt = con.prepareStatement(query);
