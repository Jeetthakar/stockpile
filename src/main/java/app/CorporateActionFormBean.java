...
public class CorporateActionFormBean extends ActionForm{
	...
	public ActionErrors validate(ActionMapping mapping,
		...
		if (( f_percentage== null)|| f_percentage.trim().equals("")){
			errors.add(null,
					new ActionError("error.percentage.required"));
		}
		if((s_stock==null)||s_stock.trim().equals("")){
			errors.add("s_stock",new ActionError("error.stock.required"));
		}
		if((s_ratio==null)||s_ratio.trim().equals("")){
			errors.add("s_ratio",new ActionError("error.ratio.required"));
		}
		return errors;
	}
